...
[assembly: SuppressMessage("StyleCop.CSharp.NamingRules", "SA1310:Field names should not contain underscore", Justification = "<Pending>", Scope = "member", Target = "~F:LiTools.Helpers.DataAccess.MongoDb.Services.MongoDbService.MONGO_MAX_DOCUMENT_SIZE")]
[assembly: SuppressMessage("StyleCop.CSharp.NamingRules", "SA1310:Field names should not contain underscore", Justification = "<Pending>", Scope = "member", Target = "~F:LiTools.Helpers.DataAccess.MongoDb.Services.MongoDbService.MONGO_SAFE_THRESHOLD")]
