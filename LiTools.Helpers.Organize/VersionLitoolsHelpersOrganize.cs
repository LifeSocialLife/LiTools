...
// </summary>
// <copyright file="VersionLitoolsHelpersOrganize.cs" company="LiSoLi">
...
namespace LiTools.Helpers.Organize
{
    ...
    /// </summary>
    public sealed class VersionLitoolsHelpersOrganize
    {
        private static readonly Assembly Assembly = typeof(VersionLitoolsHelpersOrganize).Assembly;
