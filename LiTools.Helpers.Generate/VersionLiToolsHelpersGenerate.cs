...
// </summary>
// <copyright file="VersionLiToolsHelpersGenerate.cs" company="LiSoLi">
...
namespace LiTools.Helpers.Generate
{
    ...
    /// </summary>
    public sealed class VersionLiToolsHelpersGenerate
    {
        private static readonly Assembly Assembly = typeof(VersionLiToolsHelpersGenerate).Assembly;
