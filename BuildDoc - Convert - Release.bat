...
xmldocmd LiTools.Helpers.Encoding\bin\Release\netstandard2.0\LiTools.Helpers.Encoding.dll Documentation --source https://github.com/LifeSocialLife/LiTools/tree/main/LiTools.Helpers.Encoding

xmldocmd LiTools.Helpers.IO\bin\Release\netstandard2.0\LiTools.Helpers.IO.dll Documentation --source https://github.com/LifeSocialLife/LiTools/tree/main/LiTools.Helpers.IO
