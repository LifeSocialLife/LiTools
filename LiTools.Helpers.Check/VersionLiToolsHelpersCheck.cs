...
// </summary>
// <copyright file="VersionLiToolsHelpersCheck.cs" company="LiSoLi">
...
namespace LiTools.Helpers.Check
{
    ...
    /// </summary>
    public sealed class VersionLiToolsHelpersCheck()
    {
        private static readonly Assembly Assembly = typeof(VersionLiToolsHelpersCheck).Assembly;
