...
// </summary>
// <copyright file="VersionLiToolsHelpersEncoding.cs" company="LiSoLi">
...
namespace LiTools.Helpers.Encoding
{
    ...
    /// </summary>
    public sealed class VersionLiToolsHelpersEncoding
    {
        private static readonly Assembly Assembly = typeof(VersionLiToolsHelpersEncoding).Assembly;
