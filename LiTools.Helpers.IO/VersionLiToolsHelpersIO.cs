...
// </summary>
// <copyright file="VersionLiToolsHelpersIO.cs" company="LiSoLi">
...
namespace LiTools.Helpers.IO
{
    ...
    /// </summary>
    public sealed class VersionLiToolsHelpersIO
    {
        private static readonly Assembly Assembly = typeof(VersionLiToolsHelpersIO).Assembly;
